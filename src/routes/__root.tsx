...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Studio for interactive 3D web, graphic and marketing solutions, serving clients worldwide — online 24/7.",
      },
      { name: "author", content: "SAIF Solutions" },
      { property: "og:title", content: "SAIF Solutions — Web, Graphic & Marketing" },
      {
        property: "og:description",
        content: "Interactive 3D web, graphic and marketing solutions, delivered worldwide.",
      },
    ...
    <QueryClientProvider client={queryClient}>
      <AvatarChatProvider>
        ...
        <footer className="border-t border-border px-6 py-10 text-center text-sm text-muted-foreground">
          © {new Date().getFullYear()} SAIF Solutions — Web, Graphic & Marketing · Web · Graphic · Marketing
        </footer>
